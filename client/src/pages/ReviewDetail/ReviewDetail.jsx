      ...
      <div className="container-center-card pt-20 sm:pt-36">
        ...
        <div className="z-10 Main large-white-card p-4 sm:p-6">
          <div className="w-full pb-4 flex-col justify-start items-start gap-3 flex">
            ...
            <div className="Profile justify-start items-start gap-3 inline-flex">
              <img
                ...
                src="https://via.placeholder.com/34x35"
              />
          ...
          <div className="py-2 text-sm font-medium">
            This user rated{' '}
            <span className=" text-brand-tq">The Glory (2022)</span>:
          </div>
          ...
          <div className="NarrativeContent w-full  py-5 border-b flex-col justify-center items-start gap-5 flex">
            <div className="w-full">
              <span className="text-gray-800 text-sm font-normal leading-[25.20px]">
                "Eternal Blossom" took me on an emotional rollercoaster from
                start to finish. The intricate plot weaves together love, loss,
                and the resilience of the human spirit. The character arcs are
                well-developed, and the dialogues are both poignant and
                memorable.
                <br />
                <br />
                The pacing of the narrative is perfect, allowing for moments of
                quiet reflection and intense, heart-pounding scenes. The romance
                is heartwarming, and the mystery element keeps you guessing
                until the very end. I appreciated the depth of the themes
                explored, and the conclusion left me with a sense of
                fulfillment.
                <br />
                <br />
              </span>
              <span className="text-gray-800 text-sm font-bold leading-[25.20px]">
                In Conclusion:
                <br />
                <br />
              </span>
              <span className="text-gray-800 text-sm font-normal leading-[25.20px]">
                "Eternal Blossom" is a must-watch Korean drama that excels in
                every aspect. The stellar performances, engaging narrative, and
                breathtaking cinematography make it a standout in the genre.
                Whether you're a fan of romance, drama, or mystery, this series
                offers a perfect blend that will leave a{' '}
              </span>
            </div>
          </div>
