...
const ToastMessage = ({ message, type, closeToast }) => {
  ...
  return (
    <div
      className={`${selectedStyle}  transition-opacity duration-500 shadow-xl border bg-theme-base flex z-[100] fixed items-center right-0 sm:right-6 top-24 max-[600px]:top-16 max-[550px]:right-4 max-[400px]:right-0 w-full max-w-[300px] p-4 mb-4 rounded-xl `}
      role="alert"
    >
