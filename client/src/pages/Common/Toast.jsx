  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={closeToast}
        className="ms-auto -mx-0.5 -my-0.5 text-light-text hover:bg-theme-base/50 rounded-lg focus:ring-2 focus:ring-text-dark focus:ring-opacity-20  inline-flex items-center justify-center h-5 w-5"
        aria-label="Close"
      >
