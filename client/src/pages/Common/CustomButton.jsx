...
const CustomButton = ({
  ...
  const sizeSets = {
    ...
    defaultResize:
      "sm:h-12 sm:px-5 sm:py-3 sm:gap-2 sm:font-medium sm:text-base \
      md:h-10 md:px-2.5 md:py-2.5 md:gap-1.5 md:font-normal md:text-sm \
      h-8 px-2.5 py-2 gap-1 font-light text-xs",
