...
const CustomButton = ({
  ...
  const styleSets = {
    ...
    inverse: 'bg-brand-tq bg-opacity-20 text-brand-tq hover:bg-opacity-60',
  };
  ...
  const sizeSets = {
    ...
    defaultResize:
      'sm:h-12 sm:px-5 sm:py-3 sm:gap-2 sm:font-medium sm:text-base h-8 px-2.5 py-2 gap-1 font-light text-xs',
