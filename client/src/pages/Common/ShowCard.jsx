...
const ShowCardSmall = ({ id }) => {
  ...
  return (
    <div onClick={onClickNavigate} className="cursor-pointer overflow-hidden w-64 shrink-0 h-[214px] bg-theme-base bg-opacity-70 rounded-[17px] flex-col justify-start items-start inline-flex">
